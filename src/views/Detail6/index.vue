  ...
  <div>
    ...
    <div class="bigboder" :class="{ bigboder2: !big }">
      <div class="middle" :class="{ middle2: !big }">
        <h3>
          信息发布&nbsp;&nbsp;｜
          &nbsp;&nbsp;2022-2023年度全球发明大会中国区协调单位名单（第四批）
        </h3>
        <div class="top">
        ...
        <div class="text">
          ...
          <span>
            &nbsp;&nbsp;&nbsp;&nbsp;根据全球发明大会中国区省级选拔赛组织要求，拟邀请以下单位：中科科技培训中心、浙商总会少创力中心、福建大象光年教育科技有限公司、海南省教育技术装备协会、柳州市小伙伴科技有限公司、新疆优生优育优教协会，协助全球发明大会中国区工作组在北京市、浙江省、福建省、海南省、广西壮族自治区、新疆维吾尔自治区开展赛事筹备活动。</span>
      ...
      <span @click="up">上一篇：新闻动态 | 美国驻华大使馆经济处、新闻文化处外交官一行...</span>
      <span @click="down">下一篇：公益培训 | 关于举办2022-2023年度全球发明大会中国区培训通知</span>
    </div>
    </div>
    <Footer />
  </div>
